...
[ЯК РЕДАГУВАТИ ЦЕЙ РЕПОЗИТОРІЙ](/docs/CONTRIBUTING.md)
---
...
tmux new -s reforger
cd ~/arma-reforger
./ArmaReforgerServer -config ./config.json -profile /home/steam/.config/ArmaReforgerServer -maxFPS 60
```
Від’єднатись: `Ctrl+B`, потім `D`
Повернутись: `tmux attach -t reforger`
...
6. **Баланс і анти-аб’юз** (No-Assault HQ, ліміти, стабільність 128 PvP)
