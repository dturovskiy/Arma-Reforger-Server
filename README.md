...
➡️ **Повний гайд для Discord (Markdown):**

* `docs/arma-reforger-linuxgsm-discord.md`

> Порада: вставляйте текст у Discord як один блок/повідомлення або використовуйте Markdown-кодблоки — так форматування не “ламається”.
